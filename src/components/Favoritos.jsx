    ...
    <>
      ...
      <div className="row">
        {favorites.map((movie, index) => {
          return (
            <div
              className="col-12 col-md-4 col-sm-6 my-4 d-flex justify-content-center"
              key={index}
            >
              <div className="card" style={{ width: "18rem" }}>
                ...
                >
                  {favorites.find((item) => item.id === movie.id.toString()) ===
                  undefined ? (
                    <svg
                  ...
                  <div>
                    ...
                    <p className="card-text overflow-hidden">
                      {movie.overview.split("").length <= 200
                        ? movie.overview
                        : movie.overview.substring(0, 100).trim() + "..."}
                    </p>
                  </div>
                  <Link
                    to={`/alkeflix/detalle?movieId=${movie.id}`}
